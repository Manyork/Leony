<%-- 
    Document   : home
    Created on : 09-oct-2019, 5:57:13
    Author     : leony1
--%>
...
<html>
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="archivos/images/favicon.png">
		...
		<!-- slicknav.min.css -->
        <link rel="stylesheet" href="archivos/css/slicknav.min.css">
		<!-- style css -->
		<link rel="stylesheet" href="archivos/css/styles.css">
		<!-- responsive css -->
        <link rel="stylesheet" href="archivos/css/responsive.css">
		<!-- modernizr css -->
        <script src="archivos/js/vendor/modernizr-2.8.3.min.js"></script>
    </head>
    <body>
        <!--[if lt IE 8]>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 hidden-sm hidden-xs">
    						<div class="logo">
    							<h1><a href="index.html">Patitos S.A</a></h1>
    						</div>
    					</div>
    						...
    						<div class="mainmenu">
    							<ul id="navigation">
    								<li class="active"><a href="index.html">Home <i class="fa fa-angle-down"></i></a>
    									<ul class="submenu">
    										<li class="active"><a href="index.jsp">Formulario Clientes</a></li>
		...
		<section class="slider-area">
			<div class="slider-active2 slider-next-prev-style">
				<div class="slider-items">
					<img src="archivos/images/slider/4.jpg" alt="" class="slider">
				...
				<div class="slider-items">
					<img src="archivos/images/slider/3.jpg" alt="" class="slider">
					<div class="slider-content text-center">
						<div class="table">
							<div class="table-cell">
								<div class="container">
					...
					<div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".3s">
                            <div class="footer-widget instagram-wrap">
                                <h2>Instagram</h2>
                                <ul>
                                    <li><a href="#"><img src="archivos/images/instagram/1.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="archivos/images/instagram/2.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="archivos/images/instagram/3.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="archivos/images/instagram/4.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="archivos/images/instagram/5.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="archivos/images/instagram/6.jpg" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank" style="color: white;"></a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        ...
        <script src="archivos/js/vendor/jquery-1.12.4.min.js"></script>
		<!-- bootstrap js -->
        <script src="archivos/js/bootstrap.min.js"></script>
		<!-- owl.carousel.2.0.0-beta.2.4 css -->
        <script src="archivos/js/owl.carousel.min.js"></script>
		<!-- counterup.main.js -->
        <script src="archivos/js/counterup.main.js"></script>
		<!-- isotope.pkgd.min.js -->
        <script src="archivos/js/imagesloaded.pkgd.min.js"></script>
		<!-- isotope.pkgd.min.js -->
        <script src="archivos/js/isotope.pkgd.min.js"></script>
		<!-- jquery.waypoints.min.js -->
        <script src="archivos/js/jquery.waypoints.min.js"></script>
		<!-- jquery.magnific-popup.min.js -->
        <script src="archivos/js/jquery.magnific-popup.min.js"></script>
		<!-- jquery.slicknav.min.js -->
        <script src="archivos/js/jquery.slicknav.min.js"></script>
		<!-- snake.min.js -->
        <script src="archivos/js/snake.min.js"></script>
		<!-- wow js -->
        <script src="archivos/js/wow.min.js"></script>
		<!-- plugins js -->
        <script src="archivos/js/plugins.js"></script>
		<!-- main js -->
